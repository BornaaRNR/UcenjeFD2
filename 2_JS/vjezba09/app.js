const isDev=true;
// funkcije je skup naredbi s odredenom svrhom, s  ciljem visestrukog poziva ->DRY

// osnovne vrste funkcija

// kod klasicne funkcije redoslijed definiranje/zvanje nije bitan
pozdraviSvijet();

// 1. Ne prima parametre, ne vraca vrijednost
// 1.1. definiranje funkcije
function pozdraviSvijet(){ //ne prima parametre jer u zagradama () nema teksta
    // tijelo funkcije
    console.log("Hello world");
    // return; -> void ne mora (ali moze) imati return
}
...
// 2. prima parametre, ne vraca vrijednost
...
// 3.2. koristenje funkcije 
log(slucajniBroj());

// kada smo kod slucajnih brojeva
log((Math.random()*1000).toFixed(0)); // ovo je ekvivalent tijelu funkcije slucajniBroj

// ovo gore ipak ne osigurava slucajne brojeve izmedu 100 i 999
log((Math.random()*(999-100)+100).toFixed(0));

log(slucajniBroj(100,999)); // odraduje isti posao kao i linija 71  ali je citljivije

// 4. prima parametre, vraca vrijednost -> NAJCESCE KORISTENA
// 4.1. definiranje funkcije
function zbrojPrimBrojeva(odBroja, doBroja){ // za ulaz 3,8 treba dati d15
...
// pozdravArrow(); ne mogu pozvati prije definiranje
