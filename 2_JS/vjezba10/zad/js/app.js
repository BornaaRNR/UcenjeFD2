...
function prikaziRezultate() {
    ...
    let ocjena = '';
    switch(rezultat){
        case 5: ocjena = 'Odličan (5)! Pravi si ES6 majstor!';
        break;
        case 4: ocjena = 'Vrlo dobar (4)! Skoro savršeno.';
        break;
        case 3: ocjena = 'Dobar (3). Solidno poznavanje.';
        break;
        case 2: ocjena = 'Dovoljan (2). Trebaš još malo učiti.';
        break;
        default: ocjena = 'Nedovoljan (1). Ponovi osnove!';
    }
