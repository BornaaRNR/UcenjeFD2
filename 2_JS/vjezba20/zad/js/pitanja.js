function kreirajPitanja() {
    ...
    {
        pitanje:'Da se nademo na mjesecu i bacimo pero i teski cekic u isto vrijeme s iste visine, sto bi prije palo na tlo?',
        tocno:'Pali bi istovremeno',
        odgovori: ['Pero', 'Cekic', 'Pali bi istovremeno']
    },
    {
