  ...
  switch (zadatak) {
    ...
    */
    ...
    case '2':
      ...
      6 % 4 = 2 + 4
      6 % 5 = 1 + 5
      1 +2 +3 = 6 zato je 6 savrsen broj

      5 % 1 = 0
      5 % 2 = 1
      5 % 3 = 2
      5 % 4 = 1
      1 != 5 -zato 5 nije savrsen broj
      */
      ...
      if(sum === b2){
        rezultat.innerHTML=`${b2} je savrsen broj`;
      } else{
        rezultat.innerHTML=`${b2} nije savrsen broj;`
      }
